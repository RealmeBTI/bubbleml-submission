...
subprocess.run(["rm", "-rf", "/tmp/kaggle_missing_v3_out"])
subprocess.run(["mkdir", "-p", "/tmp/kaggle_missing_v3_out"])
subprocess.run(["python3", "-m", "kaggle", "kernels", "output", kernel, "-p", "/tmp/kaggle_missing_v3_out"])
