...
| Manuscript PDF | BLOCKED | No elsarticle-capable TeX environment |
...
| License | BLOCKED | MIT selected; root `LICENSE` missing |
...
| IJHMT requirements | BLOCKED | Current guide checked; TeX/portal/license gates remain |
