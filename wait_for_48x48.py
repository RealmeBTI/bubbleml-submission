...
subprocess.run(["mkdir", "-p", "/tmp/kaggle_48x48_out"])
subprocess.run(["python3", "-m", "kaggle", "kernels", "output", kernel, "-p", "/tmp/kaggle_48x48_out"])
print("Output downloaded to /tmp/kaggle_48x48_out.")
