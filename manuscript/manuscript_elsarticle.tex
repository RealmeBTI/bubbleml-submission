...
\texttt{BIBLIOGRAPHY\_VERIFICATION.md}. The author-designated repository
URL is \url{https://github.com/RealmeBTI/bubbleml-submission}; no public
release URL or DOI is asserted because neither has been independently
verified.}
...
check was also run at native 384\ensuremath{\times}384 resolution to test direct execution
and memory feasibility only (not convergence or ranking).

\pandocbounded{\includegraphics[width=\linewidth]{../submission/figures/fig6_split_design.pdf}}
...
\pandocbounded{\includegraphics[width=\linewidth]{../submission/figures/fig5_benchmark_workflow.pdf}}
