...
**Figure 2.** The tutorial split evaluates a fixed three-trajectory comparison; the independent cross-condition split directly tests transfer of that comparison to two held-out conditions. The roles were frozen before training or test inspection.
